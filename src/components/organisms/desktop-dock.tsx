      ...
      <div className="flex-center gap-5 px-5 py-2.5 rounded-2xl glass-button">
        {items.map((item) => (
          ...
          >
            ...
            <span className="absolute -top-9 left-1/2 -translate-x-1/2 px-3 py-1 glass-button text-primary dark:text-primary-dark rounded-lg text-modern opacity-0 group-hover:opacity-100 whitespace-nowrap animate-fade group-hover:-translate-y-1 pointer-events-none select-none">
              {item.label}
            </span>
          </div>
        ))}
