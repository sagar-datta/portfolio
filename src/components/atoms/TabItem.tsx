    ...
    return (
      <button
        ...
        tab-transitions
          ...
          ${
            isSelected
              ? `bg-glass-blur dark:bg-glass-blur-dark backdrop-blur-glass font-semibold active:bg-glass-blur/80 active:dark:bg-glass-blur-dark/80 md:bg-button-light md:dark:bg-button-dark md:backdrop-blur-none`
              : "bg-glass-blur/30 dark:bg-glass-blur-dark/30 backdrop-blur-glass/30 active:bg-glass-blur/50 active:dark:bg-glass-blur-dark/50 md:bg-transparent md:backdrop-blur-none"
          }
        `}
      >
        <span
